...
SECRET_KEY = os.environ.get('SECRET_KEY', os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-zx92%)xcg94q@r#_8&qh33fd1^u66)*alj!%ote+jovgu4%q#4'))
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'photo_gallery.context_processors.user_profile',
            ],
        },
    },
]
